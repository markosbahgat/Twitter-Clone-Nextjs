...
const SpeedDial = ({OwnerId, PostId}) => {
    ...
    return ( 
        <div className={styles.speed_dial}>
            ...
            <ul className={styles.dials}>
                <li><i className="far fa-bookmark fa-lg" onClick={() => dispatch(appendBookmarks(PostId))}></i></li>
                <li><i className="fas fa-link" onClick={() => {navigator.clipboard.writeText( "http://localhost:1000/user/" + OwnerId)}}></i></li>
